...
def test_calc_scene_summary(populated_scene_index, tmpdir):
    ...
    _expect_values(
        ...
        newest_creation_time=datetime(2017, 7, 4, 11, 17, 6, tzinfo=tzutc()),
        timeline_period="day",
        timeline_count=30,
    )
    ...
    _expect_values(
        store.update("ls8_nbar_scene", year=2017, month=None, day=None),
        dataset_count=1227,
    ...
    # All time
    _expect_values(
        store.update("ls8_nbar_scene", year=None, month=None, day=None),
        dataset_count=2474,
