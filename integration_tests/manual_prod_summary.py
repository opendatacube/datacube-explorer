...
def main():
    ...
    assert s.newest_dataset_creation_time == datetime(
        2017, 12, 7, 1, 24, 58, 134221, tzinfo=tzutc()
    )
    ...
    assert s.newest_dataset_creation_time == datetime(
        2017, 2, 26, 10, 22, 45, 256080, tzinfo=tzutc()
    )
    assert s.period == 'day'
    assert s.time_range == Range(
        begin=datetime(2000, 1, 1, 0, 0),
        end=datetime(2001, 1, 1, 0, 0)
    )
    ...
    assert s.newest_dataset_creation_time == datetime(
        2017, 6, 14, 2, 25, 33, 600040, tzinfo=tzutc()
    )
    assert s.period == 'day'
    assert s.time_range == Range(
