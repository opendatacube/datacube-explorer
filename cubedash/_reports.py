...
def reports_time_page(year: int = None, month: int = None):
    return flask.render_template(
        "reports-time.html", report_type="", year=year, month=month
    )
...
def differences_time_page(year: int = None, month: int = None):
    return flask.render_template(
        "reports-time.html", report_type="Differences", year=year, month=month
    )
...
def differences(
    ...
    diff_counts = (
        selected_summary_1.dataset_counts - selected_summary_2.dataset_counts
